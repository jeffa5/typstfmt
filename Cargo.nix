  ...
  internal = rec {
    ...
    crates = {
      ...
      "typst-fmt" = rec {
        ...
        edition = "2021";
        crateBin = [
          { name = "typst-fmt"; path = "src/main.rs"; }
        ];
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fibersapi" "fileapi" "memoryapi" "minwindef" "processenv" "processthreadsapi" "std" "winbase" "wincon" "winerror" "winnt" ];
      };
